...
try {
    ...
    // Create companies
    $pdo->exec("INSERT INTO company (name, address, email, created_at) VALUES 
        ('Tech Solutions Inc', '123 Tech St, San Francisco, CA', 'hr@techsolutions.com', NOW()),
        ('Digital Marketing Agency', '456 Market St, New York, NY', 'jobs@digitalmarketing.com', NOW())");
    
    echo "Companies created\n";
    
    // Create job offers (using single salary column)
