...
// ✅ Create router هنا قبل أي addRouter
$router = new Router();
...
$router->addRouter('GET',  '/admin/tags/edit',     [AdminTagController::class, 'edit']);   // ?id=...
...
$router->addRouter('GET',  '/admin/categories/edit',    [AdminCategoryController::class, 'edit']);   // ?id=...
